...
<!-- Primary Navigation
			============================================= -->
			<nav id="primary-menu" class="<?php echo $header_var['design']['nav_style']; ?>">
				...
				<?php ancms_get_template_part( 'template-parts/header/nav', 'cta' ); ?>
				
				<?php ancms_get_template_part( 'template-parts/header/nav', 'search' ); ?>
